...
public class PassportReader : NSObject {
    ...
    public var signedData : [UInt8] = []
    private var challenge : Array<UInt8>?
    ...
    public func readPassport( challenge:[UInt8], mrzKey : String, tags: [DataGroupId] = [], skipSecureElements :Bool = true, customDisplayMessage: ((NFCViewDisplayMessage) -> String?)? = nil, completed: @escaping (NFCPassportModel?, NFCPassportReaderError?)->()) {
